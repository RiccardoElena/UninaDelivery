...
public interface TransportDAO {
  ...
  /**
   * Retrieve all the transports of a specific deposit
   * from the database.
  ...
  /**
   * Retrieve all available transports of a specific deposit
   * from the database.
  ...
  List<Transport> getAvailableTransportsByDeposit(Deposit deposit)
      throws SQLException;
