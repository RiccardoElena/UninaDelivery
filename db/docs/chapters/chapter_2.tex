...
% BUG : @RiccardoElena isAvaiable field from driver right? (Removed)
...
\customTable{ccY}[Dizionario dei vincoli Seconda Parte]{\textbfB{Vincolo} & \textbfB{Tipologia} & \textbfB{Descrizione}}{
  ...
  \textbf{formatCoversOccupiedSpace} & Dominio & % BUG : @RiccardoElena i changed this from Transport to Covers. Or we can just delete    
  {\footnotesize
...
\customTable{ccY}[Dizionario dei vincoli Terza Parte]{\textbfB{Vincolo} & \textbfB{Tipologia} & \textbfB{Descrizione}}{
  ...
  \textbf{checkTransportFullness} & Relazionale & % BUG: @RiccardoElena is the name of the trigger correct?
  {\footnotesize
