...
% FIXME: @zGenny there's a HUGE problem in the assosation between Area and Address. The cardinality is wrong. It should be N to 1 and not N to N. We should discuss this asap.
\begin{center}
