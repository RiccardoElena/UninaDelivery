...
\customTableLogic{|Y|Y|Y|}{3}{Order}{
  \underline{OrderID} & EmissionDate & isExpress \\
  \hline
  ExtraWarranty & IsCompleted & \textit{Email}
}

\customTableLogic{|Y|Y|Y|Y|Y|}{5}{Contains}{
  \textit{OrderID} & \textit{Name} & \textit{Supplier} & IsSent & Quantity
}
